...
class class__khung_sua_sanpham_menu_doc
{
	...
	function khung_sua_sanpham_menu_doc()
	{
		...
		$mo_ta_ngan					=	str_replace("<br>","",$mo_ta_ngan);
		$mo_ta_ngan					=	str_replace("<br />","",$mo_ta_ngan);
		if($loai_gia=="lien_he")
		{
			$gia="";
		...
		echo "<tr>";
			...
			echo "<td width=\"80%\" align=\"left\">";
				...
				echo "<div style='overflow:scroll;width:600px;height:400px;display:none' id='sss2' >";
		...
		/*echo "<tr>";
				...
				echo "<tr>";
					...
					echo "<td width=\"80%\" align=\"left\"><textarea name='mo_ta_ngan' style='width:300px;height:60px'>$mo_ta_ngan</textarea>";
