...
<?php
	...
	$sql="select * from dulieu order by id desc limit $vtbd,$so_gioi_han";
	$q_sql=mysql_query($sql);
?>
<?php
...
?>
<div class="headboxpro"><a href='javascript:voild(0)' >Sản phẩm mới</a>
...
<?php
	...
	$sdl__18=mysql_fetch_row(mysql_query("select count(*) from dulieu"));
	//thongbao($sdl__18);
	$st=ceil($sdl__18[0]/$so_gioi_han);
