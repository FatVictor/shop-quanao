	...
	class phantrang_xuatlink
{
	...
	function xuat_tintuc($so_gioi_han,$base_url)
	{
		...
		while($r_sql=mysql_fetch_array($q_sql))
		{
			...
			$id_tt=$r_sql['id'];
			$link=$base_url."?thamso=chitiet_tintuc&id=$id_tt&id_active_mnn=$_GET[id_active_mnn]";
			?>
				<tr>
...
a.aaa_7:hover
{
	...
	<?php
		...
		$tv_1=mysql_query($tv);
		$tv_2=mysql_fetch_row($tv_1);
		xuat_tintuc($so_gioi_han,$base_url);
